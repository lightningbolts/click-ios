...
/// The app's liquid glass tab bar, attached to each tab's root screen so it naturally transitions
/// on navigation push and pop gestures (including interactive back), matching WhatsApp.
